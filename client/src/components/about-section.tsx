        ...
        <div className="scroll-reveal">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="w-full h-96 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-2xl glass-morphism flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-muted">Professional Photo</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted text-lg leading-relaxed" data-testid="about-description-1">
              ...
              <p className="text-muted text-lg leading-relaxed" data-testid="about-description-2">
              ...
              <div className="grid grid-cols-2 gap-6 mt-8">
                {stats.map((stat, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <Card className="glass-morphism" data-testid={`stat-${stat.label.toLowerCase()}`}>
